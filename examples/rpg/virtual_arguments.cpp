...
struct RollDice : Action {
    void operator ()(std::span<std::string>) const final {
        roll_dice();
    }
};
...
struct Learn : Action {
    void operator ()(std::span<std::string> args) const final {
        ...
        learn(Wizard {args[0]}, Spell {args[1]});
    }
};
...
struct Channel : Action {
    void operator ()(std::span<std::string> args) const final {
        ...
        channel(Wizard {args[0]}, Mana {args[1]});
    }
};
...
struct AddSpell : Action {
    void operator ()(std::span<std::string> args) const final {
        ...
        add_spell(Spell {args[0]}, Mana {args[1]});
    }
};
...
struct AddWizard : Action {
    void operator ()(std::span<std::string> args) const final {
        ...
        add_wizard(Wizard {args[0]}, Mana {args[1]});
    }
};
